                            ...
                            (execution, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {status === "IN_PROGRESS" && (
                                            <div className="je-parts-section je-time-section">
                                                ...
                                                <div className="je-parts-form je-time-form">
                                                    ...
                                                    <button type="button" className="je-record-part-btn je-record-time-btn"
...
.je-detail-copy strong{font-size:10px}
.je-parts-section,
.je-photo-section,
.je-notes{
  margin:0 20px;
...
.je-parts-section:first-of-type{border-top:0}
.je-parts-header{
...
.je-parts-title .je-section-icon{
...
.je-parts-form{
  display:grid;
  grid-template-columns:minmax(220px,1fr) 120px 90px 105px 112px;
  gap:10px;
  align-items:end;
  padding:14px;
...
.je-parts-field input,
.je-parts-field select{
  width:100%;
  height:38px;
  box-sizing:border-box;
  padding:0 11px;
...
.je-parts-field input:focus,
.je-parts-field select:focus{
  border-color:#8d96bf;
  box-shadow:0 0 0 3px rgba(49,59,104,.08);
}
.je-parts-stock,
.je-parts-cost{
  min-height:38px;
...
.je-parts-stock strong,
.je-parts-cost strong{
  color:#313b68;
  font-size:12px;
}
.je-record-part-btn{
...
.je-record-part-btn:hover:not(:disabled){
  background:#242b50;
}
.je-time-section{
  padding-top:16px;
...
.je-time-form{
  grid-template-columns:120px minmax(180px,1fr) 108px;
  align-items:end;
}
.je-record-time-btn{
  background:#527a68;
}
.je-record-time-btn:hover:not(:disabled){
  background:#416653;
}
.je-parts-list{
  margin-top:12px;
...
.je-part-row{
  display:grid;
  grid-template-columns:minmax(220px,1fr) 70px 110px 110px;
  align-items:center;
  gap:14px;
  padding:11px 13px;
  background:#fffdfa;
}
.je-part-row + .je-part-row{
...
.je-part-main span{margin-top:3px}
.je-part-qty,
.je-part-price,
.je-part-total{
  text-align:right;
...
.je-part-qty strong,
.je-part-price strong,
.je-part-total strong{
  display:block;
  margin-top:3px;
  color:#313b68;
  font-size:10px;
